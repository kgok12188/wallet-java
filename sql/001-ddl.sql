...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='归集熔断';
...
CREATE TABLE `agg_queue` (
  ...
  `chain_id` varchar(200) NOT NULL COMMENT '链ID,比如BTC,ETH',
  `wallet_id` int NOT NULL DEFAULT '0' COMMENT '扫描的区块高度',
...
) ENGINE=InnoDB AUTO_INCREMENT=469912 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `symbol_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb3 COMMENT='币种配置表';
...
) ENGINE=InnoDB AUTO_INCREMENT=126 DEFAULT CHARSET=utf8mb3 COMMENT='钱包地址';
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb3 COMMENT='币种配置表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='提现任务'